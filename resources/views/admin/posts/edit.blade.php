...
<div class="row">
    <div class="col-md-12">
        <a href="{{ route('post.index',['filial'=> $filial]) }}" class="btn btn-primary float-right"><i class="fa fa-arrow-left"></i> Listar Posts</a>
            <h3>Editar post</h3>            
        </div>
    </div>
@stop
...
@section('content')
<form action="{{ route('post.update', ['filial'=> $filial,'post' => $post]) }}" method="post">
    @method('put')
    @csrf
    <div class="card">
        <div class="card-body">
